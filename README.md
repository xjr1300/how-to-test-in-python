...
> これは、[SOLID原則](https://zenn.dev/nakurei/books/solid-principle-kanzen-rikai/viewer/what-is-solid-principle)の`依存関係逆転の原則`に該当します。
...
> 質素なオブジェクトは、[SOLID原則](https://zenn.dev/nakurei/books/solid-principle-kanzen-rikai/viewer/what-is-solid-principle)の`単一責任の原則`に該当します。
